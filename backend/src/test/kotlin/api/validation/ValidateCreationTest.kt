...
class ValidateCreationTest {
    ...
    @Test
    fun `when dto is valid, validateCreation should return a correctly mapped BookCreationPayload`() = runBlocking {
    ...
    @Test
    fun `when title is blank, a ValidationException should be thrown`() {
    ...
    @Test
    fun `when title is longer than 500 characters, a ValidationException should be thrown`() {
    ...
    @Test
    fun `when author is blank, a ValidationException should be thrown`() {
    ...
    @Test
    fun `when author is longer than 500 characters, a ValidationException should be thrown`() {
    ...
    @Test
    fun `when status is not valid, a ValidationException should be thrown`() {
