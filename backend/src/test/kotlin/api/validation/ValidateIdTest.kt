...
class ValidateIdTest {
    ...
    @Test
    fun `when id is a valid UUID string, the correct UUID should be returned`() = runBlocking {
    ...
    @Test
    fun `when id is null, a ValidationException should be thrown`() {
    ...
    @Test
    fun `when id is not a valid UUID string, a ValidationException should be thrown`() {
        assertFailsWith<ValidationException> {
