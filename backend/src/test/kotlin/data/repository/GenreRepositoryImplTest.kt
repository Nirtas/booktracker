...
class GenreRepositoryImplTest : RepositoryTestBase() {
    ...
    @Test
    fun `when getGenres is called and the genres table is empty, it should return an empty list`() = runBlocking {
        transaction {
            Genres.deleteAll()
        }
    ...
    @Test
    fun `when getGenresByIds is called with a list of non-existent IDs, it should return an empty list`() =
        runBlocking {
    ...
    @Test
    fun `when getGenresByIds is called with an empty ID list, it should return an empty list`() =
        runBlocking {
