...
class GenresValidatorTest {
    ...
    @Test
    fun `when all genres exist, the validation should complete without errors`() = runBlocking {
    ...
    @Test
    fun `when one or more genres are not found, a ValidationException should be thrown`() = runBlocking {
